...
class TeacherProfile extends Component {
  ...
  refreshTeacher = () => {
    ...
    const getQUizzes = this.quizServices.getTeacherQuizzes(teacher_id);

    Promise.all([getTeacher, getCourses, getQUizzes])
      .then((response) =>
        this.setState({
          teacher: response[0].data,
          courses: response[1].data,
          quizzes: response[2].data,
        })
      )
      .catch(() => {
      ...
      >
        ...
        >
          ...
          <Row className="justify-content-center">
            ...
            <Col xs="auto">
              <Button onClick={this.deleteTeacher} variant="danger">
                Delete teacher
              </Button>
            </Col>
          </Row>
        ...
        <Container className="teacher-profile">
            ...
            <>
              <Row>
                <Col md={{ span: 8 }} lg={{ span: 8 }}>
                  <p className="instructor" style={{ color: "#73726c" }}>
                    INSTRUCTOR
                  </p>
                  <h1>
                  ...
                  <p>
                    <strong>{this.state.teacher.jobOccupation}</strong>
                  </p>
                  <hr></hr>
                  {this.props.teacherInfo &&
                  this.props.teacherInfo._id === this.state.teacher._id ? (
                    <h3>
                      <strong>About me</strong>
                    </h3>
                  ) : (
                    <h3>
                      <strong>About the theacher</strong>
                    </h3>
                  )}
                      ...
                      {this.props.teacherInfo &&
                        this.props.teacherInfo._id ===
                          ...
                          <>
                            ...
                            <Link
                              to="/profile-teacher/create-quiz"
                              className="course-add mt-2"
                            >
                              Add quiz
                            </Link>
                          </>
              ...
              <Row>
                {this.state.courses.length > 0 ? (
                  ...
                  <Col className="cta">
                    <Row className="d-flex justify-content-between">
                      <p className="mt-2 mb-0">
                        ...
                        <strong>{this.state.teacher.name}</strong>! Create an
                        Engaging Course.
                      </p>
                      <Link
                        to="/profile-teacher/create-course"
                  ...
                  <Col className="cta">
                    <Row className="d-flex justify-content-between">
                      <p className="mt-2 mb-0">
                        This teacher hasn't created couerses yet.
                      </p>
              ...
              <Row>
                <Col md={12}>
                  {this.props.teacherInfo &&
                  this.props.teacherInfo._id === this.state.teacher._id ? (
                    <h2 className="mt-5 mb-5">My quizzes</h2>
                  ) : (
                    <h2 className="mt-5 mb-5">Teacher's quizzes</h2>
                  )}
                </Col>
              </Row>
                ...
                {this.state.quizzes.length ? (
                  ...
                  <Col className="cta">
                    <Row className="d-flex justify-content-between">
                      <p className="mt-2 mb-0">
                        Let's start teaching,{" "}
                        <strong>{this.state.teacher.name}</strong>! Create a
                        high iq quiz.
                      </p>
                      <Link
                        to="/profile-teacher/create-course"
          ...
          <Link to="/teachers" className="btn btn-outline-dark mt-5">
            Go back
          </Link>
        </Container>
      </motion.div>
